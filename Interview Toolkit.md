...
怎么说呢，平时大部分写code的时候其实都有个参考，然后就是copy paste。真的做第一道算法题的时候，会发现，很多API的名字记！不！清！！！

熊本熊看天。jpg

[HackerRank](https://www.hackerrank.com)很适合初出茅庐的面试者，总体框架已经set up好，你只要写算法的核心部分就好了。而且大部分算法题比较基础简单，对于熟悉基本的算法和数据结构有很大帮助。

像我这样的战五渣，大概在HackerRank上狂做题了一个礼拜吧，我就转战LeetCode了。

[LeetCode](http://leetcode.com)上分简易，中等，难。最后刷完的时候我大概把简易都做完了，中等刷了可能有一半？难的话大致看了看，很多题目之所以标为难是因为requirements模糊，你在做题之前需要首先和面试官沟通明确需求。好吧，这其实是我的借口，后面真的没有时间刷了。。。但是，我都会九阴真经和白骨爪了啊！我还怕个毛线！

谨记，最开始的时候，真的会被虐哭，因为感觉什么都不会，但是没有关系，虐着虐着，就不那么痛了。

除了这两个刷题网站外，我还把[CareerCup](https://www.careercup.com)网站上我要面的公司的题目整理了一下，上面的题目比较新，大概过一遍没什么问题的话对增强信心很有帮助。

然后就是[GeeksforGeeks](http://www.geeksforgeeks.org)，有的算法看不懂的话，可以去那上面看看，讲解很仔细，而且基本每道题目都会给出好几种方法，对于融会贯通所学的知识点很有帮助。
...
在整个面试的过程中，HR的作用也至关重要，Google的电面我是最后投的，之前已经有面其他一些公司。后来Google的HR跟我说Google的面试流程下来正常来说大概需要6-8个礼拜，电面到出结果1-2个礼拜，安排onsite，面试到出结果大概2-4个礼拜，出offer大概2个礼拜。知道的时候我就已经慌了，因为我知道很多公司都是当天面完当天出offer。于是和HR商量，尽可能把所有的行程都缩到最短，所以才有了上面的时间线。
